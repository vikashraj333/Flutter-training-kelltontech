              ...
              GridView.count(
                ...
                children: [
                  buildFoodItem('Cup Cake', 'Best Cake in Twin Cities', 50,
                      'assets/images/img2.jpg', 123, 456, 1),
                  buildFoodItem('Sprinkle Cake', 'Best Cake in Twin Cities',
                      250, 'assets/images/img3.jpg', 123, 456, 2),
                  buildFoodItem('Rainbow Cake', 'Best Cake in Twin Cities', 500,
                      'assets/images/img4.webp', 123, 456, 3),
                ],
              )
            ],
          )
            ...
            children: [
              ...
              Padding(
                ...
                child: Text(
                  name,
                  style:
                      const TextStyle(fontFamily: 'Quicksand', fontSize: 14.0),
                ),
              ),
              const SizedBox(
                height: 4.0,
